...
export default function LiquidEther({
  ...
  useEffect(() => {
    ...
    class CommonClass {
      ...
      fboWidth: any = null; fboHeight: any = null; time = 0; delta = 0;
    ...
    class AutoDriver {
      mouse: any; manager: any; enabled: any; speed: any; resumeDelay: any;
      rampDurationMs: any; active = false;
      current = new THREE.Vector2(0, 0);
      target = new THREE.Vector2();
      lastTime = performance.now();
      activationTime = 0; margin = 0.2;
    ...
    class ShaderPass {
      props: any; uniforms: any; scene: any; camera: any; material: any; geometry: any; plane: any; line: any;
    ...
    class WebGLManager {
      props: any; lastUserInteraction: any; autoDriver: any; output: any; running = false;
